--- 
title: "Estatística e Análise de Dandos"
...
![Imagem 1: Complexo Bushveld](./data/CB.png)
...
O dataset contendo os dados analisados neste trabalho pode ser acessado no seguinte [link](https://www.kaggle.com/saurabhshahane/multivariate-geochemical-classification).
...
|--------|-------------------------------------|----|
|HoleType|Tipo do furo que foi coletada a amostra|Categórico|
|MaxDepth|Profundidade máxima da coleta da amostra|Categórico|
...
|Stratigraphy|Posição estratigráfica das camadas de cromitita dentro da Zona Crítica a partir da base para cima|Numérica|

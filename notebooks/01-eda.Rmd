...
Essas correlações, tanto positiva quanto negativa, indicam que ao aplicarmos PCA conseguiremos um número de componentes **q** menor que o número de variáveis originais **p** que descreve bem a dispersão e a variabilidade dos dados.

...
```
Analisando os testes qui-quadrados de todas as combinações das variáveis rejeitamos todas as hipoteses nulas correspondentes aos pares de variáveis analisadas nos testes qui-quadrados, pois **p-value < 0.05**. A hipotese Ho rejeitada afirma que o par te variáveis analisada no teste são idependentes.

...
- As variáveis numéricas incluem várias medidas destintas inclusivé rácios. Desta forma, o modelo poderá atribuir um peso superior a uma das variáveis fruto da sua unidade de medida. As variáveis numéricas serão normalizadas durante o préprocessamento.
